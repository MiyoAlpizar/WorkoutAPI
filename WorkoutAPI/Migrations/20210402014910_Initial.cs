        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SecondMuscle = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RutineSeries", x => new { x.RutineId, x.SerieId });
                    table.ForeignKey(
                        name: "FK_RutineSeries_Rutines_RutineId",
                        column: x => x.RutineId,
                        principalTable: "Rutines",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RutineSeries_Series_SerieId",
                        column: x => x.SerieId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SerieWorkouts", x => new { x.SerieId, x.WorkoutId });
                    table.ForeignKey(
                        name: "FK_SerieWorkouts_Series_SerieId",
                        column: x => x.SerieId,
                        principalTable: "Series",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SerieWorkouts_Workouts_WorkoutId",
                        column: x => x.WorkoutId,
                        principalTable: "Workouts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Images_WorkoutId",
                table: "Images",
                column: "WorkoutId");

            migrationBuilder.CreateIndex(
                name: "IX_RutineSeries_SerieId",
                table: "RutineSeries",
                column: "SerieId");

            migrationBuilder.CreateIndex(
                name: "IX_SerieWorkouts_WorkoutId",
                table: "SerieWorkouts",
                column: "WorkoutId");
